...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var greatherThanSix = numbers.Where(num => num > 6);
            Console.WriteLine("Greater Than Six:");

            foreach (var item in greatherThanSix)
            {
                Console.WriteLine(item);
            }

            //TODO: Order numbers in any order (acsending or desc) but only print 4 of them **foreach loop only!**
            Console.WriteLine("First Four Only:");
            ...
            employees = employees.Append(new Employee("Jess", "lastName", 33, 1)).ToList();
